...
const OrderSummary = () => {
    ...
    const { selectItems, totalPrice, tax, taxRate, grandTotal } = useSelector((store) => store.cart);

    const handleClearCart = () => {
        dispatch(clearcart());

    }
    // payment interagation
    ...
    return (
        <div className='bg-primary-light mt-5 rounded text-base'>
            <div className='px-6 py-4 space-y-5'>
                <h2 className='text-xl text text-text-dark'>Order Summary</h2>
                <p>SelectedItems: {selectItems}</p>
                ...
                <div className='px-4 mb-6'>
                    <button
                     onClick={(e) => {
                        ...
                        className='bg-red-600 px-3 py-1.5 text-white mt-2 rounded-md flex justify-between items-center'>
